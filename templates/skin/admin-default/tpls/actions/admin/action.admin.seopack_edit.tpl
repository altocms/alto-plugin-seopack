...
{block name="content-bar"}
    <div class="btn-group">
        <a href="{router page='admin'}seopack/" class="btn btn-primary"><i class="icon icon-chevron-left"></i></a>
    </div>
{/block}
        ...
        <div class="b-wbox-content nopadding">
            <form action="" method="POST" class="form-horizontal uniform" enctype="multipart/form-data">
				...
				<div class="control-group">
					<label for="url" class="control-label">{$aLang.plugin.seopack.seopack_create_url}</label>
				...
				<div class="control-group">
					<label for="seopack-title-form-text" class="control-label">{$aLang.plugin.seopack.seopack_create_title}</label>
				...
				<div class="control-group">
					<label for="seopack-title-form-text" class="control-label">{$aLang.plugin.seopack.seopack_create_description}</label>
				...
				<div class="control-group">
					<label for="seopack-title-form-text" class="control-label">{$aLang.plugin.seopack.seopack_create_keywords}</label>
